...
//전체 배열 출력(테스트용 전체 정상 및 인덱스번호 확인)
console.log(array1) 
//개별 배열 직접출력(이벤트,속성,메서드 동적결과제작)
...
//-------------------------------- 객체
//배열은 2개 이상으 데이터가 서로 연관되어 있어야 한다.
//쇼핑몰 옵션: size배열, color배열, option배열 개별 구성
//const product_size = ['S', 'M', 'L']
//const prduct_color = ['white','black','yellow']

//객체는 2개 이상dml 데이터가 속성:값으로 이루어져 있기 때문에 
...
console.log(cat1.color) //객체.속성 개별확인
