...
//if(조건식){조건결과가 참일 떄 실행결과} //기본문법
//1. 사용자가 입력한 숫자가 짝수면 '짝수입니다' 결과출력
/* const num1 = Number(window.prompt('1~99 사이 숫자를 입력하세요'))
if(num1%2===0){
    window.alert('짝수입니다!')
} */
//2. 하루 걸움수를 입력받고 만보 이상일 경우 '목표달성' 출력
// const num2 = Number(window.prompt('오늘의 걸음 수를 입력해주세요'))
// if(num2 >= 10000){
//     window.alert('목표달성!!')
// }
//--------------------------------------------------------------------
...
//100~90 A
//A가 아니라면 모두 F
const grade = Number(window.prompt('시험점수를 입력해주세요'))
if(grade<101 || grade>=90){
        window.alert('당신은 A학점입니다.')
}else{
    window.alert('당신은 F학점입니다.')
}
