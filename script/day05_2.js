//배열과 객체
const a = 1 //1//상수(변하지 않는 값)
//a = 2//error (상수값을 변경할 때 에러 발생)
let b = 2 //2//변수(변할 수 있는 값)
...
const colorArray = ['red', 'yellow', 'green', 'blue', 'purple']
const weatherArray = ['흐림', '맑음', '비', '눈', '태풍']
const color = document.querySelector('.color')
const weather = document.querySelector('.weather')
color.innerHTML = `${colorArray[1]}`
color.style.backgroundColor='yellow'
weather.innerHTML = `${weatherArray[1]}`
weather.style.backgroundColor = 'skyblue'
